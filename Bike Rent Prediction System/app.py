...
#change the path with the path where your model.pkl file is exist
bike_model_pkl = r"C:\Users\Lenovo\Muskan\Ml\github assignment\Machine-Learning-Projects\Linear_Regression\bike_rental\model.pkl"
